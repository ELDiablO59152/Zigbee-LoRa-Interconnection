...
uint16_t humidityHex(void) {
    ...
    do {
        value = (uint16_t)SPIReceive(0x00);
    } while ((value & 0x00C0) == 0x00);

    value = (value << 6) | (uint16_t)SPIReceive(0x00) >> 2;
...
uint16_t temperatureHex(void) {
    ...
    do {
        trash = SPIReceive(0x00);
    } while ((trash & 0xC0) == 0x00);
    trash = SPIReceive(0x00);

    value = ((uint16_t)SPIReceive(0x00) << 6) | (uint16_t)SPIReceive(0x00) >> 2;
...
uint16_t humidityDec(void) {
    ...
    uint16_t humidite = (uint16_t)(humidityHex() / (16384.0 - 2) * 10000);
